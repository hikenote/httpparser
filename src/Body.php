...
class Body
{
    ...
    public function __construct($stream)
    {
        if (!is_resource($stream)) {
            throw new \InvalidArgumentException('\Http\Body::__construct() argument must be a valid PHP resource');
        }
        $this->attach($stream);
    }
    ...
    public function attach($newStream)
    {
        if (is_resource($newStream) === false) {
            throw new \InvalidArgumentException('\Http\Body::attach() argument must be a valid PHP resource');
        }
